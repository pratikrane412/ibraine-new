...
const reviews = [
  {
    ...
    content:
      "The website design they created for our fintech startup is absolutely stunning. Clean, modern, and converts like crazy. Our investor meetings became so much easier.",
  ...
  },
  {
    ...
    content:
      "Working with this team was seamless. They took our rough ideas and turned them into a polished, professional website that perfectly captures our brand. The feedback has been overwhelmingly positive.",
  ...
  },
  {
    ...
    role: "CEO, Singapore",
    content:
      "Coming from Webflow templates, this custom design was a game-changer. They understood our brand identity perfectly. The attention to detail is incredible.",
  ...
  },
  {
    ...
    content:
      "They transformed our outdated agency website into something that actually wins us clients. The portfolio showcase and case study layouts are designed so well that our lead quality improved dramatically.",
  ...
  },
  {
    ...
    content:
      "The SaaS dashboard design exceeded all our expectations. Complex data visualization made simple and beautiful. Our enterprise clients love the clean interface.",
  ...
  },
  {
    ...
    content:
      "The landing page design they created has tripled our conversion rates. Beautiful animations, clear messaging, and a user flow that just works. Best investment we've made.",
  ...
  },
  {
    ...
    content:
      "From concept to launch, they were professional, creative, and responsive. The design system they built for us is now being used across all our digital products.",
  ...
  },
  {
    ...
    role: "VP Product, USA",
    content:
      "Their UI/UX expertise is world-class. They redesigned our entire platform and made it accessible, beautiful, and incredibly user-friendly. Retention improved by 45%.",
  ...
  },
  {
    ...
    content:
      "The mobile app design they created is absolutely gorgeous. Every screen, every micro-interaction, every color choice feels intentional. Highly recommended.",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-zinc-600 dark:text-zinc-400 text-lg max-w-xl mx-auto">
            ...
            to have worked with some of the best in the industry.
          </p>
        </div>
        ...
        */}
        <div
          className="relative h-[800px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 overflow-hidden 
