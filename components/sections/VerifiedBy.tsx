...
const GoogleBadge = () => (
  <div className="w-32 h-32 bg-white border border-gray-200 rounded-lg flex flex-col items-center justify-center shadow-sm relative overflow-hidden group">
    ...
    <div className="text-center leading-none">
      <span className="block text-gray-500 text-[10px] font-medium">
        Google
      </span>
...
const ClutchBadge = () => (
  <div className="relative w-32 h-36 flex items-center justify-center drop-shadow-md">
    ...
    <svg
      viewBox="0 0 100 115"
      className="absolute inset-0 w-full h-full fill-white stroke-slate-700 stroke-2"
    >
  ...
  <div className="w-32 h-32 bg-white rounded-full border-4 border-blue-100 relative flex items-center justify-center shadow-md">
    ...
    <div className="relative z-10 text-center flex flex-col items-center">
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
        className="w-8 h-8 text-orange-500 mb-1"
      >
      ...
      <span className="text-[8px] font-bold text-blue-500 uppercase tracking-wide">
        Top Digital
      </span>
