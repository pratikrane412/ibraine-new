...
export const WhyChooseUs = () => {
  ...
  return (
    <section
      ref={targetRef}
      className="relative h-[500vh] bg-white dark:bg-zinc-950 transition-colors duration-300"
    >
      <div className="sticky top-0 flex h-screen items-center overflow-hidden">
        ...
        <motion.div style={{ x }} className="flex relative z-10">
          {/* =========================================
              PANEL 1: TITLE (Blue & Orange Text)
             ========================================= */}
          <div className="w-[100vw] h-screen flex flex-col justify-center shrink-0 border-r border-zinc-100 dark:border-zinc-800 relative px-10 md:px-32">
            <div className="absolute top-20 left-20 text-zinc-300">
              <Plus />
            </div>
            <div className="absolute bottom-20 right-20 text-zinc-300">
              <Plus />
            </div>

            {/* Small Label in Orange */}
            <span
              className="font-bold tracking-[0.2em] uppercase mb-4 block"
              style={{ color: BRAND_ORANGE }}
            >
              Why Choose Us
            </span>

            {/* Main Title: Design (Blue) & Strategy (Orange) */}
          ...
          <div className="w-[80vw] h-screen flex items-center justify-center shrink-0 border-r border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/20">
            <div className="max-w-4xl px-12">
              ...
              <p className="text-zinc-500 dark:text-zinc-400 text-lg leading-relaxed mb-12 max-w-2xl">
                We dive deep into data to find the hidden opportunities your
                competitors are missing. It's not magic; it's math.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {["Google Ads", "SEO", "Analytics"].map((btn) => (
                  <div
                    key={btn}
                    className="flex items-center gap-2 px-6 py-2 rounded-full border border-zinc-300 dark:border-zinc-700"
                  >
                    <div
          ...
          {/* =========================================
              PANEL 3: CIRCLE STATS (Blue Titles, Orange Stats)
             ========================================= */}
          <div className="w-[80vw] h-screen flex items-center justify-center shrink-0 border-r border-zinc-100 dark:border-zinc-800">
            <div className="flex flex-col gap-12 w-full px-20">
              {reasons.map((item, i) => (
                <div
                  key={i}
                  className="flex items-center justify-between group border-b border-zinc-200 dark:border-zinc-800 pb-8"
                >
                  <div>
                    {/* Title in Brand Blue */}
                    <h4
                  ...
                  {/* Circle with Brand Orange Text */}
                  <div
                    className={`w-20 h-20 rounded-full border-2 border-zinc-200 dark:border-zinc-700 flex items-center justify-center group-hover:text-white transition-all duration-300 group-hover:scale-110`}
                  >
                    <span
          ...
          {/* =========================================
              PANEL 4: BIG NUMBERS (Blue Background)
             ========================================= */}
          <div
          ...
          {/* =========================================
              PANEL 5: CONCLUSION (Orange Background)
             ========================================= */}
