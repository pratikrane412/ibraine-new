...
const ConnectorLeftToRight = () => (
  <svg className="absolute top-full left-[20%] w-[60%] h-24 hidden md:block z-0 pointer-events-none text-orange-500/50 dark:text-orange-500/40" viewBox="0 0 400 100" fill="none" preserveAspectRatio="none">
              ...
              <div key={index} className="relative">
                ...
                <div className={`flex flex-col md:flex-row items-center gap-12 md:gap-0 ${isEven ? 'md:flex-row-reverse' : ''}`}>
                  ...
                  >
                    ...
                    <h2 className={`text-[5rem] md:text-[8rem] font-black leading-none tracking-tighter ${isEven ? 'md:text-left' : 'md:text-right'}`}>
